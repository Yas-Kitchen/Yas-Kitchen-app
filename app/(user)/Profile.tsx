...
const Profile = () => {
  ...
  return (
    <ScrollView>
      <View className="font-poppins ios:mt-16 mt-5 mx-5">
        <Text className="text-[#212529] font-poppins-semibold text-[16px]">
          Profile
        </Text>
        <View className="font-poppins mt-5 flex-row gap-4 items-center mb-4">
          <TouchableOpacity
            onPress={async () => {
            ...
            className="font-poppins w-20 h-20 rounded-full bg-primary items-center justify-center overflow-hidden"
          >
            {loading ? (
              ...
              <Image
                ...
                className="font-poppins w-full h-full rounded-full"
              />
            ) : (
        ...
        <View className="font-poppins bg-white/50 rounded-xl border border-base_color/10">
          ...
          <View className="font-poppins h-[1px] w-full bg-base_color/10" />
          <EditProfile
        ...
        <View className="font-poppins bg-white/50 mt-10 rounded-xl border border-base_color/10">
          <MainSetting
        ...
        >
          ...
          <Text className="font-poppins text-primary">Logout</Text>
        </TouchableOpacity>
      </View>
